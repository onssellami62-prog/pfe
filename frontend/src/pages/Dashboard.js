        ...
        <div className="dashboard-layout">
            <aside className="sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    {/* Gestion Clients */}
                    {hasAccess('clients') && (
                        <button className={`nav-item ${activeNav === 'clients' ? 'active' : ''}`} onClick={() => navTo('clients')}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    {/* Gestion Factures */}
                    {(hasAccess('create') || hasAccess('depot') || hasAccess('factures') || hasAccess('avoirs')) && (
                        <>
                            ...
                            {gestionOpen && (
                                <div className="submenu">
                                    ...
                                    {hasAccess('avoirs') && (
                                        <button className={`nav-item submenu-item ${activeNav === 'avoirs' ? 'active' : ''}`} onClick={() => navTo('avoirs')}>
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                                                <polyline points="9 22 9 12 15 12 15 22" />
                                            </svg>
                ...
                <div className={`sidebar-user ${activeNav === 'profile' ? 'active' : ''}`}
                    onClick={() => navTo('profile')} style={{ cursor: 'pointer' }}>
